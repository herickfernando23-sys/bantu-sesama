...
export function CampaignCard({
  ...
  const filledCollected = Math.max(0, collected > 0 ? collected : computedCollectedFromDonations);
  const filledDonors = Math.max(0, donors > 0 ? donors : computedDonorsFromDonations);
